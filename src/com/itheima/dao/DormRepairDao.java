...
public interface DormRepairDao {
    //获取总条数
    Integer totalCount(@Param("d_dormitoryid") Integer d_dormitoryid, @Param("d_dormbuilding") String d_dormbuilding);

    //获取用户列表
    List<DormRepair> getDormRepairList(@Param("d_dormitoryid") Integer d_dormitoryid, @Param("d_dormbuilding") String d_dormbuilding,
