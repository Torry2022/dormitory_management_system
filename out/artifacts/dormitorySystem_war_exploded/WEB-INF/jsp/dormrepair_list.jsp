...
<body>
    <div class="x-nav">
      <span class="layui-breadcrumb">
        ...
        <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="/findDormRepair"
           title="刷新">
            ...
            <div class="layui-col-md10">
                <form class="layui-form" id="addEmployeeForm">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" lay-verify="required" name="r_name" class="layui-input"
                                   placeholder="请输入维修人员">
                        </div>
                    </div>
